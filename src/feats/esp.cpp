            ...
            while (!shuttingDown) {
                ...
                if (*enabled) {
                    ...
                    auto collectActors = [&scannedActors](const auto& actors) {
                        if (!actors.empty()) {
                            scannedActors.insert(scannedActors.end(), actors.begin(), actors.end());
                        }
                    };
        ...
        void hRenderCanvas(SDK::UGameViewportClient* viewport, SDK::UCanvas* canvas) {
            ...
            if (*enabled && canvas) {
                ...
                for (size_t i = 0; i < locations.size(); i++) {
                    ...
                    canvas->K2_DrawLine(characterScreenLocation, screenLocation, 1.0f, SDK::FLinearColor(1.f, 0.f, 0.f, 1.f));

                    canvas->K2_DrawText(font,
                                        names[i],
                                        screenLocation,
                                        SDK::FVector2D(1.f, 1.f),
                                        SDK::FLinearColor(1.f, 0.f, 0.f, 1.f),
                                        1.0f,
                                        SDK::FLinearColor(0.f, 0.f, 0.f, 1.f),
                                        SDK::FVector2D(0.f, 0.f),
                                        true, true, true,
                                        SDK::FLinearColor(1.f, 1.f, 1.f, 1.f));
                    ...
                    canvas->K2_DrawText(font,
                                        ...
                                        SDK::FVector2D(1.f, 1.f),
                                        SDK::FLinearColor(0.f, 0.f, 1.f, 1.f),
                                        1.0f,
                                        SDK::FLinearColor(0.f, 0.f, 0.f, 1.f),
                                        SDK::FVector2D(0.f, 0.f),
                                        true, true, true,
